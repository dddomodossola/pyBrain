class NeuroBase():
	def __init__(self,senseNeurones,motoNeurones):
	...
	def feedback(self,feed):
		key = self.getCandidateOutputKey( self.m_lastBinInput )
...
class Brain():
	def __init__(self,senseNeurones,motoNeurones,memInputSize,memOutputSize):
		...
		self.m_neuroBase = NeuroBase(senseNeurones+(memInputSize*senseNeurones)+(memOutputSize*motoNeurones),motoNeurones)
